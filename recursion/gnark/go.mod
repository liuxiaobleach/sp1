...
require (
	...
	github.com/ingonyama-zk/icicle/v2 v2.2.0 // indirect
...
replace github.com/consensys/gnark => github.com/celer-network/gnark v0.0.8-0.20240516142903-a33cd0872875
